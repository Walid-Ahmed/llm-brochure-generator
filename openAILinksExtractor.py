...
class OpenAILinksExtractor:
    def __init__(self):
        ...
        # Basic check to see if the API key looks valid
    ...
    def get_links(self, url):
        ...
        # Call the OpenAI API with system + user prompts
        response = self.openai.chat.completions.create(
            ...
            response_format={"type": "json_object"}  # Ensure model returns proper JSON
        )
...
if __name__ == "__main__":
    ...
    openAILinksExtractor = OpenAILinksExtractor()
    # Run link extraction on Hugging Face’s homepage
    response = openAILinksExtractor.get_links("https://huggingface.co")
